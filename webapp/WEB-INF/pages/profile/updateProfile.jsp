...
<body style="background-color: white;">
	...
	<div class="update-container">
		<h1 class="update-title">Register</h1>
		...
		<div class="form-container">
			<form action="${pageContext.request.contextPath}/updateProfile"
				...
				<div class="form-row">
					<div class="form-field">
						<label for="oldPassword" class="form-label">Old Password:</label> <input
							type="password" id="oldPassword" name="oldPassword" class="form-input"
							required>
					</div>
					<div class="form-field">
