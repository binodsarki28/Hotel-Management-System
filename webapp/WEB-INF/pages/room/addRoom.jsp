            ...
            <form action="${pageContext.request.contextPath}/addRoom"
                ...
                <div class="form-row">
                    <div class="form-field">
                        ...
                        <input type="number" id="roomNo" name="roomNo"
                               class="form-input" value="${param.roomNo}" required>
                    </div>
                    <div class="form-field">
                        <label for="roomType" class="form-label">Room Type:</label>
                        <input type="text" id="roomType" name="roomType"
                               class="form-input" value="${param.roomType}" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-field">
                        ...
                        <input type="number" step="0.01" id="pricePerDay"
                               name="pricePerDay" class="form-input" value="${param.pricePerDay}" required>
                    </div>
                    <div class="form-field">
                ...
                <div class="form-row">
                    <div class="form-field" style="width: 100%;">
                        ...
                        <input type="file" id="roomPhoto" name="roomPhoto"
